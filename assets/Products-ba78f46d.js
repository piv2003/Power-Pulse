...
`,Ma=re.svg`
  ...
  padding: 3px 4px;
`,Wt=(n,t=24)=>{if(n.length>t){const r=n.lastIndexOf(" ",t);return r!==-1?Xe(n.substring(0,r))+"...":Xe(n.substring(0,t))+"..."}return Xe(n)};function Xe(n){return n.charAt(0).toUpperCase()+n.slice(1)}const Yt=({product:n,addProductDetails:t,rf:r})=>{const i=()=>{t(n)},e=xe(Rn.getUserMetricData).blood;return S.jsxs(Ea,{ref:r,children:[S.jsxs(Oa,{children:[S.jsx(wa,{children:S.jsx(Pa,{children:"Diet"})}),S.jsxs("div",{style:{display:"flex"},children:[S.jsx(Fa,{children:n.groupBloodNotAllowed[e]?S.jsxs(S.Fragment,{children:[S.jsx(zt,{style:{backgroundColor:"#419B09"}}),S.jsx(Nt,{children:"Recommended"})]}):S.jsxs(S.Fragment,{children:[S.jsx(zt,{style:{backgroundColor:"#E9101D"}}),S.jsx(Nt,{children:"Not recommended"})]})}),S.jsxs(Da,{onClick:i,children:["Add",S.jsx("svg",{width:16,height:16,style:{stroke:"#E6533C"},children:S.jsx("use",{href:`${Ee}#icon-start`})})]})]})]}),S.jsxs(Ca,{children:[S.jsx(Ma,{width:24,height:24,children:S.jsx("use",{href:`${Ee}#icon-running`})}),Wt(n.title)]}),S.jsxs(Sa,{children:[S.jsxs(Qe,{children:[S.jsx(Ke,{children:"Calories: "}),n.calories]}),S.jsxs(Qe,{children:[S.jsx(Ke,{children:"Category: "}),Wt(n.category,13)]}),S.jsxs(Qe,{children:[S.jsx(Ke,{children:"Weight: "}),n.weight]})]})]})},Ia=N.div`
...
`,tu=N.svg`
    width: 16px;
    height: 16px;
    stroke: rgba(239, 237, 232, 0.3)`,nu=({calories:n,onModal:t})=>{const r=i=>{i.target===i.currentTarget&&t()};return S.jsx(Ga,{onClick:r,children:S.jsxs(Qa,{children:[S.jsx(Ka,{onClick:r,children:S.jsx("use",{href:Ee+"#icon-close"})}),S.jsxs(Xa,{children:[S.jsx(qa,{src:Ya,alt:"product"}),S.jsx(Ja,{children:"Well done"}),S.jsxs(Gt,{children:["Calories: ",S.jsx(Za,{children:n})]})]}),S.jsx(eu,{onClick:r,children:"Next product"}),S.jsx(Ln,{to:"/diary",children:S.jsxs(Gt,{children:["To the diary",S.jsx(tu,{children:S.jsx("use",{href:Ee+"#icon-start"})})]})})]})})},ru=()=>{let n=Number(xe(Dn));const t=xe(ga),r=xe(va),i=xe(Fn),[e,u]=E.useState(!1),[s,o]=E.useState(!1),a=at(),l=t>=n*50,[c,f]=E.useState(),[g,p]=E.useState(),h=()=>{u(!e)},v=()=>{o(!s)},d=E.useRef(),m=E.useCallback(b=>{l&&(r||(d.current&&d.current.disconnect(),d.current=new IntersectionObserver(F=>{F[0].isIntersecting&&a(jn(n+1))}),b&&d.current.observe(b)))},[a,l,r,n]),y=b=>{f(b),u(!0)},C=b=>p(b);return S.jsxs(xa,{children:[e&&S.jsx(Wa,{product:c,getCalories:C,onModal:h,onSecondModal:v}),s&&S.jsx(nu,{calories:g,onModal:v}),(i==null?void 0:i.length)>0?i.map((b,F)=>i.length===F+1?S.jsx(Yt,{rf:m,product:b,addProductDetails:y},qe()):S.jsx("div",{children:S.jsx(Yt,{product:b,addProductDetails:y},qe())},qe())):r?S.jsx(Kn,{}):S.jsx(_a,{})]})},Qt="/Power-Pulse-79/assets/products_background_desktop-55179e50.jpg",iu=re.div`
  ${Xn}
  margin-top: 61px;
  padding-top: 40px;
  padding-bottom: 80px;
